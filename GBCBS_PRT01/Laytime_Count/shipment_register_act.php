...
$stmt = $pdo->prepare(
  "INSERT INTO shipments(shipment_password, vessel_name, project_name, contract_year, shipment_number, operation_location, operation_rate, dem_rate, des_rate, input_id, input_group)
  VALUES(:shipment_password, :vessel_name, :project_name, :contract_year, :shipment_number, :operation_location, :operation_rate, :dem_rate, :des_rate, :input_id, :input_group)");
...
$stmt->bindValue(':input_id', $input_id, PDO::PARAM_INT);  //Integer（数値の場合 PDO::PARAM_INT)
